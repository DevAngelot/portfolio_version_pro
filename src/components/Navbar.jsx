...
export function Navbar() {
  ...
  return <header className="sticky top-0 z-50 border-b border-white/10 bg-[#07111f]/90 backdrop-blur-xl">
    <div className="container-page flex h-18 items-center justify-between">
      ...
      <a href="/angelotmpata.pdf" target="_blank" className="hidden border border-[#d88a5b] px-5 py-2.5 text-sm font-bold text-[#e5a17a] transition hover:bg-[#d88a5b] hover:text-[#07111f] sm:inline-flex">Télécharger mon CV</a>
